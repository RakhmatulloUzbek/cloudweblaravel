                    ...
                    <div class="menu_area alt-font">
                        <nav class="navbar navbar-expand-lg navbar-light p-0 current">
                            ...
                            <div class="navbar-header navbar-header-custom">
                                <!-- logo -->
                                <a href="index.html" class="navbar-brand1 logodefault"><img id="logo" src="{{asset('assets')}}/home/img/logos/logo.png" alt="logo"></a>
                                <!-- end logo -->
                            </div>
                            ...
                            <ul class="navbar-nav ms-auto" id="nav" style="">
                                ...
                                <li class="has-sub"><span class="submenu-button"></span><a href="#!">Elements</a>
                                    <ul class="row megamenu sub-menu">
                                        ...
                                        <li class="col-lg-3 has-sub"><span class="submenu-button"></span>
                                            <span class="d-block m-0 mb-lg-3 py-2 py-lg-0 px-1-9 px-lg-0 text-uppercase sub-title">Elements 02</span>
                                            <ul class="sub-menu">
                                        ...
                                        <li class="col-lg-3 has-sub"><span class="submenu-button"></span>
                                            <span class="d-block m-0 mb-lg-3 py-2 py-lg-0 px-1-9 px-lg-0 text-uppercase sub-title">Elements 03</span>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="responsive-videos.html"><i class="fas fa-video me-2"></i>Responsive Videos</a></li>
                                            </ul>
                                        </li>
                                        <li class="col-lg-3 has-sub"><span class="submenu-button"></span>
                                            <span class="d-block m-0 mb-lg-3 py-2 py-lg-0 px-1-9 px-lg-0 text-uppercase sub-title">Elements 04</span>
                                            <ul class="sub-menu">
