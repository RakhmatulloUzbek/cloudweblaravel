    ...
    <div id="rev_slider_2" class="rev_slider fullscreenbanner" style="display: none;" data-version="5.4.5">
        <ul>
            <li data-transition="parallaxtoright">
                ...
                <img src="{{asset('assets')}}/home/img/slider/slide3.jpg" alt="slide1" class="rev-slidebg">
                ...
                <div class="tp-caption tp-resizeme max-style alt-font" id="slide-1-layer-1"
                     ...
                     data-hoffset="['40','40','0','0']" data-voffset="['-100','-100','-100','-120']" data-width="none"
                ...
                <div class="tp-caption tp-resizeme slider-text" id="slide-1-layer-2"
                     data-x="['left','left','center','center']" data-y="['middle','middle','middle','middle']"
                     data-hoffset="['45','45','0','0']" data-voffset="['-20','-20','-20','-40']"
                     data-fontsize="['18','20','20','20']" data-lineheight="['30','30','28','28']" data-width="none"
                    ...
                    <p class="white-space px-3 px-md-0">Exhaustive technology of implementing Multipurpose projects is
                        putting your project successful.</p>
                </div>
                <!-- layer nr. 3 -->
                <div class="tp-caption tp-resizeme" id="slide-1-layer-3" data-x="['left','left','center','center']"
                     ...
                     data-voffset="['65','65','65','65']" data-fontsize="['14','14','14','14']"
                     data-lineheight="['24','24','24','24']" data-width="none" data-height="none"
...
{{--                    <a href="#!" class="butn primary"><span>Daha fazla</span></a>--}}
                </div>
            </li>
            <li data-transition="parallaxtoright">
                ...
                <img src="{{asset('assets')}}/home/img/slider/slide1.jpg" alt="slide2" class="rev-slidebg">
                <!-- layer 1 -->
                <div class="tp-caption tp-resizeme max-style alt-font" id="slide-2-layer-1"
                     ...
                     data-hoffset="['0','0','0','0']" data-voffset="['-100','-100','-100','-120']" data-width="none"
                     data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;"
                     data-transform_in="x:[-175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0.01;s:3000;e:Power3.easeOut;"
                     data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;"
                     data-mask_in="x:[100%];y:0;s:inherit;e:inherit;" data-start="1000" data-splitin="chars"
                ...
                <div class="tp-caption tp-resizeme slider-text" id="slide-2-layer-2"
                     data-x="['center','center','center','center']" data-y="['middle','middle','middle','middle']"
                     data-hoffset="['0','0','0','0']" data-voffset="['-20','-20','-20','-40']"
                     data-fontsize="['18','20','20','20']" data-lineheight="['30','30','28','28']" data-width="none"
                     data-height="none" data-transform_idle="o:1;"
                     data-transform_in="x:[175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0.01;s:3000;e:Power3.easeOut;"
                     data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;"
                    ...
                    <p class="white-space text-center px-3 px-md-0">Exhaustive technology of implementing Multipurpose
...
{{--                    <a href="#!"class="butn primary"><span>Daha fazla</span></a>--}}
            ...
            <li data-transition="parallaxtoright">
                ...
                <img src="{{asset('assets')}}/home/img/slider/slide7.jpg" alt="slide3" class="rev-slidebg">

                <!-- layer 1 -->
                <div class="tp-caption tp-resizeme max-style alt-font" id="slide-3-layer-1"
                     data-x="['right','right','center','center']" data-y="['middle','middle','middle','middle']"
                     data-hoffset="['40','40','0','0']" data-voffset="['-100','-100','-100','-120']" data-width="none"
                     data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;"
                     data-transform_in="x:[-175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0.01;s:3000;e:Power3.easeOut;"
                     data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;"
                ...
                <div class="tp-caption tp-resizeme slider-text" id="slide-3-layer-2"
                     ...
                     data-mask_in="x:[-100%];y:0;s:inherit;e:inherit;" data-start="2500" data-splitin="none"
                     data-splitout="none" data-responsive_offset="on"
                     style="z-index: 5; white-space: nowrap; color: #fff; line-height: 22px; text-align: right;">
                    <p class="white-space text-end px-3 px-md-0">Exhaustive technology of implementing Multipurpose
                        projects is putting your project successful.</p>
                </div>
                <!-- layer nr. 3 -->
                <div class="tp-caption tp-resizeme" id="slide-3-layer-3" data-x="['right','right','center','center']"
                     data-y="['middle','middle','middle','middle']" data-hoffset="['40','40','0','0']"
                     data-voffset="['65','65','65','65']" data-fontsize="['18','18','14','14']"
                     data-lineheight="['26','26','22','22']" data-width="none" data-height="none"
                     data-transform_idle="o:1;"
