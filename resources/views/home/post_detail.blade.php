            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <ul class="ps-0">
                        ...
                        <li><a href="{{route('posts')}}">Postlar</a></li>
                        <li><a class="active">Post Detail</a></li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage"
                                                ...
                                                <div class="owl-item cloned" style="width: 756px;">
                                                    <div class="item"><img src="{{Storage::url($post->image)}}"
                                                                           alt="..."></div>
                                                </div>
                                    ...
                                    <ul class="meta ps-0">
                                        ...
                                        <li>
                                            <a href="{{route('categoryservices',['id'=>$post->category->id])}}">
                                                <i class="fa fa-folder-open" aria-hidden="true"></i> {{$post->category->title}}
                                            </a>
                                        </li>
                                        <li>
                                            <a>
                                                <i class="fas fa-calendar-alt" aria-hidden="true"></i> {{date_format($post->created_at,"d/M/Y")}}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{route('posts')}}">
